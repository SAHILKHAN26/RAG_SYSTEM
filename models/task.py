...
from typing import Any, Literal, List, Optional         # Type hints for flexibility and structure
...
class Task(BaseModel):
    ...
    agent_name: Optional[str] = None  # Name of the agent giving the response
...
class TaskSendParams(BaseModel):
    ...
    conversationId: Optional[str] = None      # Optional conversation ID to group tasks 
